...
class TaskServiceTests {
    ...
    void generatesAllAppropriateTasks() {
        ...
        ImmutableEntry entry = ImmutableEntry.of(TransitDataFormat.GTFS.fieldName(), TestConstants.EXAMPLE_URL, Constants.FINTRAFFIC_BUSINESS_ID)
            .withId(1000000L)
        ...
        BDDMockito.given(rulesetService.selectRulesets(entry.businessId(), Type.VALIDATION_SYNTAX, TransitDataFormat.GTFS, Set.of()))
            .willReturn(Set.of(ImmutableRuleset.of(entry.id(), RuleName.GTFS_CANONICAL_4_1_0, "bleh", Category.GENERIC, Type.VALIDATION_SYNTAX, TransitDataFormat.GTFS)));
